...
namespace SimpleWordFrequencyAnalyzer
{
    /// <summary>
    ...
    public static class Application
    {
        ...
        public static void Run()
        {
            try
            {
                ...
                var alphabeticallyOrdered = frequencyOrdered.OrderBy(kvp => kvp.Key);
                Repository.SaveAll(alphabeticallyOrdered.Select(x => x.ToString()));
            }
            catch (Exception ex)
            {
